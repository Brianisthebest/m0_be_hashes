...
states.each do |state_name, state_abrv|
  p "The states name is #{state_name} and the abbreviation is #{state_abrv}."
end
...
birthdays.each do |name, birthday|
  p "My friends name is #{name} and their birthday is on #{birthday}!"
end
